Cd.seed do |s|
	...
	s.price = 1543
	s.stock = 100
	s.release_date = "2018/2/22"
	s.cd_introduction = "モーニング娘。誕生20周年を記念する今回のミニアルバムは、現役メンバー13人とモーニング娘。1期メンバー5人の奇跡のコラボ！モーニング娘。インディーズシングル『愛の種』から、メジャーデビューシングル『モーニングコーヒー』、さらに未収録ライブ発表曲や現役&OGコラボ曲、歴代9名のリーダーだけのレコーディング曲、完全未発表新曲を豪華収録！見逃せない1枚です！"
end
